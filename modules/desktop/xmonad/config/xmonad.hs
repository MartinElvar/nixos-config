...
myKeys c =
  ...
  , ("M-M1-e", addName "Launch files"          $ spawn "nautilus")
  ...
  , ("M-<Tab>", addName "Toggle noborders/full" $ sendMessage (MT.Toggle NBFULL) >> sendMessage ToggleStruts)]
  ...
  -- Controls for spotify player use spotify-spt (SUPER-u followed by a key)
  ...
  , ("<XF86AudioMute>", addName "Toggle audio mute"   $ spawn "wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle")
  , ("<XF86AudioLowerVolume>", addName "Lower vol"    $ spawn "wpctl set-volume -l 1.5 @DEFAULT_AUDIO_SINK@ 5%-")
  , ("<XF86AudioRaiseVolume>", addName "Raise vol"    $ spawn "wpctl set-volume -l 1.5 @DEFAULT_AUDIO_SINK@ 5%+")
